...
export const Login = () => {
  ...
  // ✅ Your working login logic with AuthContext
  ...
  return (
    <>
      ...
      >
        ...
        {/* ── Card ── */}
        <div
          className="card-in relative z-10 flex w-full max-w-4xl rounded-3xl overflow-hidden"
          style={{
        ...
        >
          ...
          {/* ── Left panel ── */}
          <div
            className="hidden md:flex flex-col items-center justify-center gap-6 w-1/2 p-12"
            style={{
          ...
          <div className="flex flex-col justify-center w-full md:w-1/2 p-10 gap-7">
            ...
            <form onSubmit={handleSubmit(submitHandle)} className="flex flex-col gap-5">
              ...
              <div className="fade-right-2 flex flex-col gap-1.5">
                ...
                <div className="relative flex items-center">
                  ...
                  <input
                    ...
                    className="input-glow w-full pl-10 pr-4 py-3.5 rounded-xl text-sm
              ...
              <div className="fade-right-2 flex flex-col gap-1.5">
                ...
                <div className="relative flex items-center">
                  ...
                  <input
                    ...
                    className="input-glow w-full pl-10 pr-16 py-3.5 rounded-xl text-sm
                               text-white placeholder-white/30 outline-none transition-all duration-200"
                    style={{
                      background: 'rgba(255,255,255,.08)',
                      border: '1px solid rgba(255,255,255,.12)',
                  ...
                  <button
                    ...
                    className="absolute right-3.5 text-xs font-semibold
              ...
              {/* ✅ Forgot Password — from your working file, styled */}
              <div className="fade-right-2 flex justify-end -mt-2">
                <Link
                  to="/forgetpassword"
                  className="text-xs font-semibold transition-colors duration-200 hover:text-purple-300"
              ...
              <div className="fade-right-3 mt-1">
                <button
                  type="submit"
                  disabled={loading}
                  className="shimmer-btn relative w-full py-4 rounded-xl text-white text-sm
                             font-bold tracking-wide overflow-hidden transition-all duration-200
                             hover:-translate-y-0.5 active:scale-[.98] disabled:opacity-60"
                  style={{
            ...
            {/* Footer */}
            <p className="fade-right-4 text-center text-xs"
