...
export const ToastMessage = ({ id, message, type = 'info', duration = 3000, onClose }) => {
  ...
  return (
    <div className={`flex items-center w-full max-w-sm p-4 mb-2 rounded-lg shadow-lg transition-all duration-300 transform 
